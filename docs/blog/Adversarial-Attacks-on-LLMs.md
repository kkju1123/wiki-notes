...
tags: []
summary: ''
fetched_at: '2026-09-20T08:43:55.534313+00:00'
---
...
![Image 1](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/threats-overview.png)

An overview of threats to LLM-based applications. (Image source: [Greshake et al. 2023](https://arxiv.org/abs/2302.12173))

### Classification

Adversarial attacks on classifiers have attracted more attention in the research community in the past, many in the image domain. LLMs can be used for classification too. Given an input and a classifier , we would like to find an adversarial version of the input, denoted as , with imperceptible difference from , such that .

### Text Generation

Given an input and a generative model , we have the model output a sample . An adversarial attack would identify such that would violate the built-in safe behavior of the model ; E.g. output unsafe content on illegal topics, leak private information or model training data. For generative tasks, it is not easy to judge the success of an attack, which demands a super high-quality classifier to judge whether is unsafe or human review.

### White-box vs Black-box

White-box attacks assume that attackers have full access to the model weights, architecture and training pipeline, such that attackers can obtain gradient signals. We don’t assume attackers have access to the full training data. This is only possible for open-sourced models. Black-box attacks assume that attackers only have access to an API-like service where they provide input and get back sample , without knowing further information about the model.
...
![Image 2](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/gumbel.png)

The probability density plot of . (Image created by ChatGPT) 
...
![Image 3](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/gumbel-softmax.png)

When the temperature is , it reflects the original categorical distribution. When , it becomes a uniform distribution. The expectations and samples from Gumbel softmax distribution matched well. (Image source: [Jang et al. 2016](https://arxiv.org/abs/1611.01144))
...
![Image 4](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/UAT.png)
...
![Image 5](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/UAT-examples.png)
...
*   Variation #1: [](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/)**UAT-LM** (Universal Adversarial Trigger with Language Model Loss) adds a constraint on language model logprob on the trigger tokens, , to encourage the model to learn sensical token combination.
...
![Image 6](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/UTSC.png)
...
![Image 7](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/UAT-variation.png)
...
![Image 8](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/zou.png)
...
![Image 9](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/zou2.png)
...
![Image 10](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/ARCA.png)
...
![Image 11](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/jailbroken.png)
...
![Image 12](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/adv-writing-ui.png)
...
![Image 13](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/ziegler-ui.png)
...
![Image 14](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/anthropic-redteam.png)
...
![Image 15](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/explore-establish-exploit.png)
...
![Image 16](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/FLIRT-SD.png)
...
![Image 17](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/saddle-point.png)
...
![Image 18](https://lilianweng.github.io/posts/2023-10-25-adv-attack-llm/PPL-passed.png)
