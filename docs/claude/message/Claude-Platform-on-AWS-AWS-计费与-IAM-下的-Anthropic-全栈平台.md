---
title: Claude Platform on AWS：AWS 计费与 IAM 下的 Anthropic 全栈平台
...
- Bedrock
- IAM
summary: 通过 AWS Marketplace 计费和 IAM 认证，使用 Anthropic 自管推理栈的 Claude API 平台，提供最新功能与 beta
  特性。
fetched_at: '2026-09-20T03:24:58.339893+00:00'
---
...
3.   ### Create your workspace and note its ID
...
| **Model IDs** |  | (with a `us.` or `global.` inference profile prefix) |  |
