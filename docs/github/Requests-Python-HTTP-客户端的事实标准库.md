---
title: Requests：Python HTTP 客户端的事实标准库
...
- 网络编程
- PyPI
summary: Requests 是简单优雅的 Python HTTP 库，用极简 API 封装 HTTP/1.1 请求与响应处理，成为最流行的 PyPI 包之一。
fetched_at: '2026-09-17T02:49:36.891132+00:00'
---
