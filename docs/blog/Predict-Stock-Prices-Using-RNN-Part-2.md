...
tags: []
summary: ''
fetched_at: '2026-09-20T08:49:03.769172+00:00'
---
...
1.   Given that the train set includes stocks, the one-hot encoding would introduce (or ) additional sparse feature dimensions. Once each stock symbol is mapped onto a much smaller embedding vector of length , , we end up with a much more compressed representation and smaller dataset to take care of.
...
In the recurrent neural network, at one time step , the input vector contains `input_size` (labelled as ) daily price values of -th stock, . The stock symbol is uniquely mapped to a vector of length `embedding_size` (labelled as ), . As illustrated in Fig. 1., the price vector is concatenated with the embedding vector and then fed into the LSTM cell.

Another alternative is to concatenate the embedding vectors with the last state of the LSTM cell and learn new weights and bias in the output layer. However, in this way, the LSTM cell cannot tell apart prices of one stock from another and its power would be largely restrained. Thus I decided to go with the former approach.

![Image 1](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/rnn_with_embedding.png)
...
Together they define the size of the embedding matrix, for which the model has to learn `embedding_size``stock_count` additional variables compared to the model in [Part 1](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/).
...
![Image 2](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/rnn_with_embedding_tensorboard.png)
...
![Image 3](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/rnn_embedding_AAPL.png)![Image 4](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/rnn_embedding_MSFT.png)![Image 5](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/rnn_embedding_GOOG.png)
...
![Image 6](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/embedding_clusters.png)
...
![Image 7](https://lilianweng.github.io/posts/2017-07-22-stock-rnn-part-2/embedding_clusters_2.png)
