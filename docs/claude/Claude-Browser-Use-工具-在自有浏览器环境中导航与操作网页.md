---
title: Claude Browser Use 工具：在自有浏览器环境中导航与操作网页
...
- Agent Loop
- 浏览器自动化
summary: Claude 通过 browser_toolset_20260801 在应用控制的浏览器中导航、读取与点击网页，以结构化元素引用和截图协同完成交互。
fetched_at: '2026-09-20T04:03:53.270803+00:00'
---
