---
title: Claude Managed Agents 工具配置：内置工具集、权限策略与 Web 域名限制
...
- Web 工具
- 权限策略
summary: 讲解如何配置 Claude Managed Agents 的内置工具集，包括启用/禁用工具、权限策略以及 Web 工具的域名与内容限制。
fetched_at: '2026-09-20T07:11:15.761680+00:00'
---
