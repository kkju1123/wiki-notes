...
tags: []
summary: ''
fetched_at: '2026-09-20T08:47:34.797694+00:00'
---
...
![Image 1](https://lilianweng.github.io/posts/2018-06-24-attention/shiba-example-attention.png)
...
![Image 2](https://lilianweng.github.io/posts/2018-06-24-attention/sentence-example-attention.png)
...
![Image 3](https://lilianweng.github.io/posts/2018-06-24-attention/encoder-decoder-example.png)
...
![Image 4](https://lilianweng.github.io/posts/2018-06-24-attention/encoder-decoder-attention.png)
...
![Image 5](https://lilianweng.github.io/posts/2018-06-24-attention/bahdanau-fig3.png)
...
| --- | --- | --- |
| Content-base attention | $\text{score} \left(\right. \mathbf{\mathit{s}}_{t} , \mathbf{\mathit{h}}_{i} \left.\right) = \text{cosine} \left[\right. \mathbf{\mathit{s}}_{t} , \mathbf{\mathit{h}}_{i} \left]\right.$ | [Graves2014](https://arxiv.org/abs/1410.5401) |
| Additive(*) | $\text{score} \left(\right. \mathbf{\mathit{s}}_{t} , \mathbf{\mathit{h}}_{i} \left.\right) = \mathbf{v}_{a}^{\top} tanh ⁡ \left(\right. \mathbf{W}_{a} \left[\right. \mathbf{\mathit{s}}_{t - 1} ; \mathbf{\mathit{h}}_{i} \left]\right. \left.\right)$ | [Bahdanau2015](https://arxiv.org/pdf/1409.0473.pdf) |
| Location-Base | $\alpha_{t , i} = \text{softmax} \left(\right. \mathbf{W}_{a} \mathbf{\mathit{s}}_{t} \left.\right)$ Note: This simplifies the softmax alignment to only depend on the target position. | [Luong2015](https://arxiv.org/pdf/1508.04025.pdf) |
| General | $\text{score} \left(\right. \mathbf{\mathit{s}}_{t} , \mathbf{\mathit{h}}_{i} \left.\right) = \mathbf{\mathit{s}}_{t}^{\top} \mathbf{W}_{a} \mathbf{\mathit{h}}_{i}$ where $\mathbf{W}_{a}$ is a trainable weight matrix in the attention layer. | [Luong2015](https://arxiv.org/pdf/1508.04025.pdf) |
| Dot-Product | $\text{score} \left(\right. \mathbf{\mathit{s}}_{t} , \mathbf{\mathit{h}}_{i} \left.\right) = \mathbf{\mathit{s}}_{t}^{\top} \mathbf{\mathit{h}}_{i}$ | [Luong2015](https://arxiv.org/pdf/1508.4025.pdf) |
| Scaled Dot-Product(^) | $\text{score} \left(\right. \mathbf{\mathit{s}}_{t} , \mathbf{\mathit{h}}_{i} \left.\right) = \frac{\mathbf{\mathit{s}}_{t}^{\top} \mathbf{\mathit{h}}_{i}}{\sqrt{n}}$ Note: very similar to the dot-product attention except for a scaling factor; where n is the dimension of the source hidden state. | [Vaswani2017](http://papers.nips.cc/paper/7181-attention-is-all-you-need.pdf) |
...
![Image 6](https://lilianweng.github.io/posts/2018-06-24-attention/cheng2016-fig1.png)
...
![Image 7](https://lilianweng.github.io/posts/2018-06-24-attention/xu2015-fig6b.png)
...
![Image 8](https://lilianweng.github.io/posts/2018-06-24-attention/luong2015-fig2-3.png)
...
![Image 9](https://lilianweng.github.io/posts/2018-06-24-attention/turing-machine.jpg)
...
![Image 10](https://lilianweng.github.io/posts/2018-06-24-attention/NTM.png)
...
![Image 11](https://lilianweng.github.io/posts/2018-06-24-attention/shift-weighting.png)

Two ways to represent the shift weighting distribution .

Finally the attention distribution is enhanced by a sharpening scalar .

The complete process of generating the attention vector at time step t is illustrated in All the parameters produced by the controller are unique for each head. If there are multiple read and write heads in parallel, the controller would output multiple sets.

![Image 12](https://lilianweng.github.io/posts/2018-06-24-attention/NTM-flow-addressing.png)
...
![Image 13](https://lilianweng.github.io/posts/2018-06-24-attention/ptr-net.png)
...
The major component in the transformer is the unit of _multi-head self-attention mechanism_. The transformer views the encoded representation of the input as a set of **key**-**value** pairs, , both of dimension (input sequence length); in the context of NMT, both the keys and values are the encoder hidden states. In the decoder, the previous output is compressed into a **query** ( of dimension ) and the next output is produced by mapping this query and the set of keys and values.
...
![Image 14](https://lilianweng.github.io/posts/2018-06-24-attention/multi-head-attention.png)
...
![Image 15](https://lilianweng.github.io/posts/2018-06-24-attention/transformer-encoder.png)
...
![Image 16](https://lilianweng.github.io/posts/2018-06-24-attention/transformer-decoder.png)
...
![Image 17](https://lilianweng.github.io/posts/2018-06-24-attention/transformer.png)
...
![Image 18](https://lilianweng.github.io/posts/2018-06-24-attention/snail.png)
...
![Image 19](https://lilianweng.github.io/posts/2018-06-24-attention/conv-vs-self-attention.png)
...
![Image 20](https://lilianweng.github.io/posts/2018-06-24-attention/SAGAN.png)
...
![Image 21](https://lilianweng.github.io/posts/2018-06-24-attention/SAGAN-examples.png)
