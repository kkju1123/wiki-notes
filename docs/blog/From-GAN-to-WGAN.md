...
tags: []
summary: ''
fetched_at: '2026-09-20T08:48:51.544048+00:00'
---
...
(1) [KL (Kullback–Leibler) divergence](https://en.wikipedia.org/wiki/Kullback%E2%80%93Leibler_divergence) measures how one probability distribution diverges from a second expected probability distribution .
...
![Image 1](https://lilianweng.github.io/posts/2017-08-20-gan/KL_JS_divergence.png)

Given two Gaussian distribution, with mean=0 and std=1 and with mean=1 and std=1. The average of two distributions is labelled as . KL divergence is asymmetric but JS divergence is symmetric.
...
![Image 2](https://lilianweng.github.io/posts/2017-08-20-gan/GAN.png)
...
According to the formula listed in the [previous section](https://lilianweng.github.io/posts/2017-08-20-gan/#kullbackleibler-and-jensenshannon-divergence), JS divergence between and can be computed as:
...
Because and , we update with and with simulitanously in one iteration, where is the learning rate. Once and have different signs, every following gradient update causes huge oscillation and the instability gets worse in time, as shown in

![Image 3](https://lilianweng.github.io/posts/2017-08-20-gan/nash_equilibrium.png)

A simulation of our example for updating to minimize and updating to minimize . The learning rate . With more iterations, the oscillation grows more and more unstable.
...
![Image 4](https://lilianweng.github.io/posts/2017-08-20-gan/low_dim_manifold.png)
...
![Image 5](https://lilianweng.github.io/posts/2017-08-20-gan/GAN_vanishing_gradient.png)
...
![Image 6](https://lilianweng.github.io/posts/2017-08-20-gan/mode_collapse.png)
...
Based on the discussion in the [previous section](https://lilianweng.github.io/posts/2017-08-20-gan/#low-dimensional-supports), we now know and are disjoint in a high dimensional space and it causes the problem of vanishing gradient. To artificially “spread out” the distribution and to create higher chances for two probability distributions to have overlaps, one solution is to add continuous noises onto the inputs of the discriminator .
...
Let us first look at a simple case where the probability domain is _discrete_. For example, suppose we have two distributions and , each has four piles of dirt and both have ten shovelfuls of dirt in total. The numbers of shovelfuls in each dirt pile are assigned as follows:
...
![Image 7](https://lilianweng.github.io/posts/2017-08-20-gan/EM_distance_discrete.png)

Step-by-step plan of moving dirt between piles in and to make them match.
...
Finally, we take the minimum one among the costs of all dirt moving solutions as the EM distance. In the definition of Wasserstein distance, the ([infimum](https://en.wikipedia.org/wiki/Infimum_and_supremum), also known as _greatest lower bound_) indicates that we are only interested in the smallest cost.
...
![Image 8](https://lilianweng.github.io/posts/2017-08-20-gan/wasserstein_simple_example.png)

There is no overlap between and when .
...
![Image 9](https://lilianweng.github.io/posts/2017-08-20-gan/WGAN_algorithm.png)
...
![Image 10](https://lilianweng.github.io/posts/2017-08-20-gan/pokemon-GAN.png)
