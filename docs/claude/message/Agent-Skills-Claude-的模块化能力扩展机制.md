---
title: Agent Skills：Claude 的模块化能力扩展机制
...
- 上下文工程
- 智能体架构
summary: Agent Skills 把领域指令、元数据和脚本打包成文件系统目录，按需加载，让通用 Claude 自动变成领域专家，降低上下文消耗。
fetched_at: '2026-09-20T06:14:41.791895+00:00'
---
