...
tags: []
summary: ''
fetched_at: '2026-09-20T08:55:10.085658+00:00'
---
...
[Skip to main content](https://docs.langchain.com/oss/python/langgraph/workflows-agents#content-area)
...
[Docs by LangChain home page![Image 9: light logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-dark-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=5babf1a1962208fd7eed942fa2432ecb)![Image 10: dark logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-light-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=0bcd2a1f2599ed228bcedf0f535b45b1)](https://docs.langchain.com/)Build
...
*   [Setup](https://docs.langchain.com/oss/python/langgraph/workflows-agents#setup)
*   [LLMs and augmentations](https://docs.langchain.com/oss/python/langgraph/workflows-agents#llms-and-augmentations)
...
*   [Routing](https://docs.langchain.com/oss/python/langgraph/workflows-agents#routing)
*   [Orchestrator-worker](https://docs.langchain.com/oss/python/langgraph/workflows-agents#orchestrator-worker)
...
*   [Evaluator-optimizer](https://docs.langchain.com/oss/python/langgraph/workflows-agents#evaluator-optimizer)
*   [Agents](https://docs.langchain.com/oss/python/langgraph/workflows-agents#agents)
    ...
    *   [Access graph state and context from tools](https://docs.langchain.com/oss/python/langgraph/workflows-agents#access-graph-state-and-context-from-tools)
...
## [​](https://docs.langchain.com/oss/python/langgraph/workflows-agents#setup)
...
![Image 13: Prompt chaining](https://mintcdn.com/langchain-5e9cc07a/dL5Sn6Cmy9pwtY0V/oss/images/prompt_chain.png?fit=max&auto=format&n=dL5Sn6Cmy9pwtY0V&q=85&s=762dec147c31b8dc6ebb0857e236fc1f)
...
![Image 14: parallelization.png](https://mintcdn.com/langchain-5e9cc07a/dL5Sn6Cmy9pwtY0V/oss/images/parallelization.png?fit=max&auto=format&n=dL5Sn6Cmy9pwtY0V&q=85&s=8afe3c427d8cede6fed1e4b2a5107b71)
...
#### [​](https://docs.langchain.com/oss/python/langgraph/workflows-agents#access-graph-state-and-context-from-tools)
...
[Thinking in LangGraph Previous](https://docs.langchain.com/oss/python/langgraph/thinking-in-langgraph)[Persistence Next](https://docs.langchain.com/oss/python/langgraph/persistence)

[Docs by LangChain home page![Image 19: light logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-dark-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=5babf1a1962208fd7eed942fa2432ecb)![Image 20: dark logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-light-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=0bcd2a1f2599ed228bcedf0f535b45b1)](https://docs.langchain.com/)
