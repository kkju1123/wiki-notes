...
tags: []
summary: ''
fetched_at: '2026-09-20T08:56:21.926394+00:00'
---
...
[Skip to main content](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#content-area)
...
[Docs by LangChain home page![Image 2: light logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-dark-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=5babf1a1962208fd7eed942fa2432ecb)![Image 3: dark logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-light-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=0bcd2a1f2599ed228bcedf0f535b45b1)](https://docs.langchain.com/)Build
...
*   [Setup](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#setup)
*   [Define subgraph communication](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#define-subgraph-communication)
    *   [Call a subgraph inside a node](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#call-a-subgraph-inside-a-node)
...
*   [Subgraph persistence](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#subgraph-persistence)
    *   [Stateful](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#stateful)
    *   [Per-invocation (default)](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#per-invocation-default)
    *   [Per-thread](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#per-thread)
    *   [Stateless](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#stateless)
    *   [Checkpointer reference](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#checkpointer-reference)

*   [View subgraph state](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#view-subgraph-state)
*   [Stream subgraph outputs](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#stream-subgraph-outputs)
...
This guide explains the mechanics of using subgraphs. A subgraph is a [graph](https://docs.langchain.com/oss/python/langgraph/graph-api#graphs) that is used as a [node](https://docs.langchain.com/oss/python/langgraph/graph-api#nodes) in another graph.Subgraphs are useful for:
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#setup)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#define-subgraph-communication)
...
### [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#stateful)
...
#### [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#per-invocation-default)
...
#### [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#per-thread)
...
### [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#stateless)
...
### [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#checkpointer-reference)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#view-subgraph-state)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-subgraphs#stream-subgraph-outputs)
...
[Memory Previous](https://docs.langchain.com/oss/python/langgraph/add-memory)[Application structure Next](https://docs.langchain.com/oss/python/langgraph/application-structure)

[Docs by LangChain home page![Image 5: light logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-dark-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=5babf1a1962208fd7eed942fa2432ecb)![Image 6: dark logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-light-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=0bcd2a1f2599ed228bcedf0f535b45b1)](https://docs.langchain.com/)
