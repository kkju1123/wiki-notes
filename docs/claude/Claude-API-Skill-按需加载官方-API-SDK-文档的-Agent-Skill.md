---
title: Claude API Skill：按需加载官方 API/SDK 文档的 Agent Skill
...
- 模型迁移
- 渐进披露
summary: 开源 Agent Skill，按需为 Claude 注入最新 Claude API 与托管代理文档，支持八语言、自动触发和模型迁移，提升集成准确性。
fetched_at: '2026-09-20T06:12:42.313321+00:00'
---
