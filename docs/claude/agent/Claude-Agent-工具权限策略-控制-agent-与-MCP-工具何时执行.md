---
title: Claude Agent 工具权限策略：控制 agent 与 MCP 工具何时执行
...
- 工具安全
- auto审批
summary: 介绍 always_allow、always_ask、auto 三种工具执行权限策略，如何按工具集和单个工具配置，并用事件流审计每次调用。
fetched_at: '2026-09-20T07:16:27.829903+00:00'
---
