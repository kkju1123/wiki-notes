...
tags: []
summary: ''
fetched_at: '2026-09-20T08:49:09.191422+00:00'
---
...
![Image 1](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/sliding_window_time_series.svg)
...
The RNN model we are about to build has LSTM cells as basic hidden units. We use values from the very beginning in the first sliding window to the window at time :

to predict the prices in the following window :

Essentially we try to learn an approximation function, .

![Image 2](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/unrolled_RNN.png)
...
[](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/)For instance, if `input_size=3` and `num_steps=2`, my first few training examples would look like:
...
The S&P 500 index increases in time, bringing about the problem that most values in the test set are out of the scale of the train set and thus the model has to _predict some numbers it has never seen before_. Sadly and unsurprisingly, it does a tragic job. See

![Image 3](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/a_sad_example_stock_prediction.png)

Fig. 3 A very sad example when the RNN model have to predict numbers out of the scale of the training data.

To solve the out-of-scale issue, I normalize the prices in each sliding window. The task becomes predicting the relative change rates instead of the absolute values. In a normalized sliding window at time , all the values are divided by the last unknown price—the last price in :
...
![Image 4](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/tensorboard1.png)
...
![Image 5](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/tensorboard2.png)
...
![Image 6](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/rnn_input1_lstm32.png)

Fig. 5a Predictoin results for the last 200 days in test data. Model is trained with input_size=1 and lstm_size=32.

![Image 7](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/rnn_input1_lstm128.png)

Fig. 5b Predictoin results for the last 200 days in test data. Model is trained with input_size=1 and lstm_size=128.

![Image 8](https://lilianweng.github.io/posts/2017-07-08-stock-rnn-part-1/rnn_input5_lstm128.png)
...
(Updated on Sep 14, 2017) The model code has been updated to be wrapped into a class: [LstmRNN](https://github.com/lilianweng/stock-rnn/blob/master/model_rnn.py). The model training can be triggered by [main.py](https://github.com/lilianweng/stock-rnn/blob/master/main.py), such as:
