---
title: uv：用 Rust 打造的极速 Python 包与项目管理器
...
- Rust
- 开发工具
summary: uv 是 Astral 团队用 Rust 开发的 Python 包与项目管理器，统一替代 pip、poetry、pyenv 等，支持锁文件、脚本和
  Python 版本管理。
fetched_at: '2026-09-17T07:15:54.004231+00:00'
---
