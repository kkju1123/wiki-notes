...
tags: []
summary: ''
fetched_at: '2026-09-20T08:48:18.875278+00:00'
---
...
In Part 2, we are about to find out more on the classic convolution neural network architectures for image classification. They lay the _**foundation**_ for further progress on the deep learning models for object detection. Go check [Part 3](https://lilianweng.github.io/posts/2017-12-31-object-recognition-part-3/) if you want to learn more on R-CNN and related models.
...
![Image 1](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/convolution-operation.png)
...
![Image 2](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/numerical_no_padding_no_strides.gif)![Image 3](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/numerical_padding_strides.gif)
...
![Image 4](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/alex_net_illustration.png)
...
![Image 5](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/residual-block.png)
...
1.   A coarse _**root filter**_ defines a detection window that approximately covers an entire object. A filter specifies weights for a region feature vector.
2.   Multiple _**part filters**_ that cover smaller parts of the object. Parts filters are learned at twice resolution of the root filter.
3.   A _**spatial model**_ for scoring the locations of part filters relative to the root.

![Image 6](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/DPM.png)
...
The quality of detecting an object is measured by the score of filters minus the deformation costs. The matching score , in laymen’s terms, is:
...
The basic score model is the dot product between the filter and the region feature vector : . The feature set can be defined by HOG or other similar algorithms.
...
![Image 7](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/DPM-matching.png)
...
![Image 8](https://lilianweng.github.io/posts/2017-12-15-object-recognition-part-2/overfeat-training.png)
...
2.   Then, we replace the top classifier layers by a regression network and train it to predict object bounding boxes at each spatial location and scale. The regressor is class-specific, each generated for one image class. 
    ...
    *   Output: , 4 values in total, representing the coordinates of the bounding box edges.
    *   Loss: The regressor is trained to minimize norm between generated bounding box and the ground truth for each training example.
