...
tags: []
summary: ''
fetched_at: '2026-09-20T08:49:17.304878+00:00'
---
...
![Image 1](https://lilianweng.github.io/posts/2017-06-21-overview/ANN.png)

A three-layer artificial neural network. (Image source: [http://cs231n.github.io/convolutional-networks/#conv](http://cs231n.github.io/convolutional-networks/#conv))
...
![Image 2](https://lilianweng.github.io/posts/2017-06-21-overview/data_size_vs_model_performance.png)

The data scale versus the model performance. (Recreated based on: [https://youtu.be/F1ka6a13S9I](https://youtu.be/F1ka6a13S9I))
...
![Image 3](https://lilianweng.github.io/posts/2017-06-21-overview/visual_cortex_system.png)
...
![Image 4](https://lilianweng.github.io/posts/2017-06-21-overview/lenet.png)

The LeNet architecture consists of two sets of convolutional, activation, and pooling layers, followed by a fully-connected layer, activation, another fully-connected layer, and finally a softmax classifier (Image source: [http://deeplearning.net/tutorial/lenet.html](http://deeplearning.net/tutorial/lenet.html))
...
![Image 6](https://lilianweng.github.io/posts/2017-06-21-overview/LSTM.png)

The structure of a LSTM cell. (Image source: [http://colah.github.io/posts/2015-08-Understanding-LSTMs](http://colah.github.io/posts/2015-08-Understanding-LSTMs))
...
![Image 7](https://lilianweng.github.io/posts/2017-06-21-overview/rnn_shakespeare.png)

A character-based recurrent neural network model writes like a Shakespeare. (Image source: [http://karpathy.github.io/2015/05/21/rnn-effectiveness](http://karpathy.github.io/2015/05/21/rnn-effectiveness))
...
![Image 8](https://lilianweng.github.io/posts/2017-06-21-overview/seq2seq_gmail.png)

A sequence-to-sequence model for generating Gmail auto replies. (Image source: [https://research.googleblog.com/2015/11/computer-respond-to-this-email.html](https://research.googleblog.com/2015/11/computer-respond-to-this-email.html))

## Autoencoders

Different from the previous models, autoencoders are for unsupervised learning. It is designed to learn a **low-dimensional** representation of a **high-dimensional** data set, similar to what [Principal Components Analysis (PCA)](https://en.wikipedia.org/wiki/Principal_component_analysis) does. The autoencoder model tries to learn an approximation function to reproduce the input data. However, it is restricted by a bottleneck layer in the middle with a very small number of nodes. With limited capacity, the model is forced to form a very efficient encoding of the data, that is essentially the low-dimensional code we learned.

![Image 9](https://lilianweng.github.io/posts/2017-06-21-overview/autoencoder.png)
...
![Image 10](https://lilianweng.github.io/posts/2017-06-21-overview/autoencoder_experiment.png)
...
![Image 11](https://lilianweng.github.io/posts/2017-06-21-overview/alphago_paper.png)![Image 12](https://lilianweng.github.io/posts/2017-06-21-overview/alphago_model.png)
...
![Image 13](https://lilianweng.github.io/posts/2017-06-21-overview/GAN.png)

The architecture of a generative adversarial network. (Image source: [http://www.kdnuggets.com/2017/01/generative-adversarial-networks-hot-topic-machine-learning.html](http://www.kdnuggets.com/2017/01/generative-adversarial-networks-hot-topic-machine-learning.html))
...
![Image 14](https://lilianweng.github.io/posts/2017-06-21-overview/deep_learning_toolkits.png)
## How to Learn?
