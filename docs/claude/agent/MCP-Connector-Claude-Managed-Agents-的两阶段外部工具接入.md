---
title: MCP Connector：Claude Managed Agents 的两阶段外部工具接入
...
- Vault 认证
- 安全配置
summary: 讲解如何通过 MCP 服务器声明和 Vault 认证分离，为托管 Agent 安全接入外部工具并精细控制可用范围。
fetched_at: '2026-09-20T07:14:42.670278+00:00'
---
