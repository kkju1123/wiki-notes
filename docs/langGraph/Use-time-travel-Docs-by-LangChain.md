...
tags: []
summary: ''
fetched_at: '2026-09-20T08:56:10.416427+00:00'
---
...
[Skip to main content](https://docs.langchain.com/oss/python/langgraph/use-time-travel#content-area)
...
*   [Overview](https://docs.langchain.com/oss/python/langgraph/use-time-travel#overview)
*   [Replay](https://docs.langchain.com/oss/python/langgraph/use-time-travel#replay)
*   [Fork](https://docs.langchain.com/oss/python/langgraph/use-time-travel#fork)
    *   [From a specific node](https://docs.langchain.com/oss/python/langgraph/use-time-travel#from-a-specific-node)

*   [Interrupts](https://docs.langchain.com/oss/python/langgraph/use-time-travel#interrupts)
    *   [Multiple interrupts](https://docs.langchain.com/oss/python/langgraph/use-time-travel#multiple-interrupts)

*   [Subgraphs](https://docs.langchain.com/oss/python/langgraph/use-time-travel#subgraphs)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-time-travel#overview)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-time-travel#replay)
...
### [​](https://docs.langchain.com/oss/python/langgraph/use-time-travel#from-a-specific-node)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-time-travel#interrupts)
...
### [​](https://docs.langchain.com/oss/python/langgraph/use-time-travel#multiple-interrupts)
...
## [​](https://docs.langchain.com/oss/python/langgraph/use-time-travel#subgraphs)
...
[Interrupts Previous](https://docs.langchain.com/oss/python/langgraph/interrupts)[Memory Next](https://docs.langchain.com/oss/python/langgraph/add-memory)

[Docs by LangChain home page![Image 7: light logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-dark-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=5babf1a1962208fd7eed942fa2432ecb)![Image 8: dark logo](https://mintcdn.com/langchain-5e9cc07a/nQm-sjd_MByLhgeW/images/brand/langchain-docs-light-blue.png?fit=max&auto=format&n=nQm-sjd_MByLhgeW&q=85&s=0bcd2a1f2599ed228bcedf0f535b45b1)](https://docs.langchain.com/)
